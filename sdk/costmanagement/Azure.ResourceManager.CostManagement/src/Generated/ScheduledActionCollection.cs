...
namespace Azure.ResourceManager.CostManagement
{
    ...
    public partial class ScheduledActionCollection : ArmCollection, IEnumerable<ScheduledActionResource>, IAsyncEnumerable<ScheduledActionResource>
    {
        ...
        public virtual AsyncPageable<ScheduledActionResource> GetAllAsync(string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ScheduledActionData, ScheduledActionResource>(new ScheduledActionOperationGroupGetAllByScopeAsyncCollectionResultOfT(_scheduledActionOperationGroupRestClient, Id, filter, context), data => new ScheduledActionResource(Client, data));
        }
        ...
        public virtual Pageable<ScheduledActionResource> GetAll(string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<ScheduledActionData, ScheduledActionResource>(new ScheduledActionOperationGroupGetAllByScopeCollectionResultOfT(_scheduledActionOperationGroupRestClient, Id, filter, context), data => new ScheduledActionResource(Client, data));
        }

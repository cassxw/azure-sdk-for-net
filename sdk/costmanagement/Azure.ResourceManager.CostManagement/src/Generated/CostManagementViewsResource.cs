    ...
    public partial class CostManagementViewsResource : ArmResource
    {
        ...
        public virtual async Task<Response<CostManagementViewsResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _viewOperationGroupRestClient.CreateGetByScopeRequest(Id.Parent, Id.Name, context);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _viewOperationGroupRestClient.CreateDeleteByScopeRequest(Id.Parent, Id.Name, context);
        ...
        public virtual async Task<ArmOperation<CostManagementViewsResource>> UpdateAsync(WaitUntil waitUntil, CostManagementViewData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _viewOperationGroupRestClient.CreateCreateOrUpdateByScopeRequest(Id.Parent, Id.Name, CostManagementViewData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<CostManagementViewData> response = Response.FromValue(CostManagementViewData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;

...
namespace Azure.ResourceManager.CostManagement
{
    ...
    public partial class BudgetCollection : ArmCollection, IEnumerable<BudgetResource>, IAsyncEnumerable<BudgetResource>
    {
        ...
        public virtual AsyncPageable<BudgetResource> GetAllAsync(string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<BudgetData, BudgetResource>(new BudgetsGetAllAsyncCollectionResultOfT(_budgetsRestClient, Id, filter, context), data => new BudgetResource(Client, data));
        }
        ...
        public virtual Pageable<BudgetResource> GetAll(string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<BudgetData, BudgetResource>(new BudgetsGetAllCollectionResultOfT(_budgetsRestClient, Id, filter, context), data => new BudgetResource(Client, data));
        }

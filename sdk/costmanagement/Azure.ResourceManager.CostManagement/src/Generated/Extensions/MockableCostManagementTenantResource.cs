...
namespace Azure.ResourceManager.CostManagement.Mocking
{
    ...
    public partial class MockableCostManagementTenantResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of CostAllocationRuleDefinitions in the <see cref="TenantResource"/>. </summary>
        ...
        public virtual CostAllocationRuleDefinitionCollection GetCostAllocationRuleDefinitions()
        {
            return GetCachedClient(client => new CostAllocationRuleDefinitionCollection(client, Id));
        }
        ...
        public virtual async Task<Response<CostAllocationRuleDefinitionResource>> GetCostAllocationRuleDefinitionAsync(string billingAccountId, string ruleName, CancellationToken cancellationToken = default)
        {
            ...
            return await GetCostAllocationRuleDefinitions().GetAsync(billingAccountId, ruleName, cancellationToken).ConfigureAwait(false);
        }
        ...
        public virtual Response<CostAllocationRuleDefinitionResource> GetCostAllocationRuleDefinition(string billingAccountId, string ruleName, CancellationToken cancellationToken = default)
        {
            ...
            return GetCostAllocationRuleDefinitions().Get(billingAccountId, ruleName, cancellationToken);
        }
        ...
        public virtual AsyncPageable<CostManagementAlertResource> GetCostManagementAlertsAsync(ExternalCloudProviderType externalCloudProviderType, string externalCloudProviderId, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<CostManagementAlertData, CostManagementAlertResource>(new AlertsGetCostManagementAlertsAsyncCollectionResultOfT(AlertsRestClient, externalCloudProviderType.ToString(), externalCloudProviderId, context), data => new CostManagementAlertResource(Client, data));
        }
        ...
        public virtual Pageable<CostManagementAlertResource> GetCostManagementAlerts(ExternalCloudProviderType externalCloudProviderType, string externalCloudProviderId, CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<CostManagementAlertData, CostManagementAlertResource>(new AlertsGetCostManagementAlertsCollectionResultOfT(AlertsRestClient, externalCloudProviderType.ToString(), externalCloudProviderId, context), data => new CostManagementAlertResource(Client, data));
        }

...
namespace Azure.ResourceManager.CostManagement
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="TenantResource"/> using the GetCostAllocationRuleDefinitions method.
    /// </summary>
    public partial class CostAllocationRuleDefinitionResource : ArmResource
    {
        ...
        {
            string resourceId = $"/providers/microsoft.Billing/billingAccounts/{billingAccountId}/providers/Microsoft.CostManagement/costAllocationRules/{ruleName}";
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> CostAllocationRuleDefinitions_Delete. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-03-01. </description>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _costAllocationRulesRestClient.CreateDeleteRequest(Id.Parent.Name, Id.Name, context);

...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetTasksCollectionResult : Pageable<BinaryData>
    {
        ...
        public BatchClientGetTasksCollectionResult(BatchClient client, string jobId, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, string filter, IEnumerable<string> @select, IEnumerable<string> expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _jobId = jobId;
            _timeout = timeout;

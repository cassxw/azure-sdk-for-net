...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetNodesCollectionResultOfT : Pageable<BatchNode>
    {
        ...
        public BatchClientGetNodesCollectionResultOfT(BatchClient client, string poolId, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, string filter, IEnumerable<string> @select, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _poolId = poolId;
            _timeout = timeout;

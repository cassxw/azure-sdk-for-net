...
{
    internal partial class BatchClientGetPoolUsageMetricsCollectionResult : Pageable<BinaryData>
    {
        ...
        public BatchClientGetPoolUsageMetricsCollectionResult(BatchClient client, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, DateTimeOffset? starttime, DateTimeOffset? endtime, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _timeout = timeout;
        ...
        /// <returns> The pages of BatchClientGetPoolUsageMetricsCollectionResult as an enumerable collection. </returns>

...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetPoolUsageMetricsCollectionResultOfT : Pageable<BatchPoolUsageMetrics>
    {
        ...
        public BatchClientGetPoolUsageMetricsCollectionResultOfT(BatchClient client, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, DateTimeOffset? starttime, DateTimeOffset? endtime, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _timeout = timeout;
        ...
        /// <summary> Gets the pages of BatchClientGetPoolUsageMetricsCollectionResultOfT as an enumerable collection. </summary>

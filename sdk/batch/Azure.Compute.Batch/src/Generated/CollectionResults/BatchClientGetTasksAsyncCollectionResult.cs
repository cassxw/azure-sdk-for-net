...
{
    internal partial class BatchClientGetTasksAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of BatchClientGetTasksAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public BatchClientGetTasksAsyncCollectionResult(BatchClient client, string jobId, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, string filter, IEnumerable<string> @select, IEnumerable<string> expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _jobId = jobId;
            _timeout = timeout;
        ...
        /// <summary> Gets the pages of BatchClientGetTasksAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BatchClientGetTasksAsyncCollectionResult as an enumerable collection. </returns>

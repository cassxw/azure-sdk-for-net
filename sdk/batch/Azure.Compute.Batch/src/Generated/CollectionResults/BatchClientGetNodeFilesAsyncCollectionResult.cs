...
{
    internal partial class BatchClientGetNodeFilesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of BatchClientGetNodeFilesAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public BatchClientGetNodeFilesAsyncCollectionResult(BatchClient client, string poolId, string nodeId, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, string filter, bool? recursive, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _poolId = poolId;
            _nodeId = nodeId;
        ...
        /// <summary> Gets the pages of BatchClientGetNodeFilesAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BatchClientGetNodeFilesAsyncCollectionResult as an enumerable collection. </returns>

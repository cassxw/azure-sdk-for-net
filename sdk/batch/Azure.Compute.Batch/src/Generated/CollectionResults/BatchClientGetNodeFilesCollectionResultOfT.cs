...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetNodeFilesCollectionResultOfT : Pageable<BatchNodeFile>
    {
        ...
        public BatchClientGetNodeFilesCollectionResultOfT(BatchClient client, string poolId, string nodeId, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, string filter, bool? recursive, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _poolId = poolId;
            _nodeId = nodeId;

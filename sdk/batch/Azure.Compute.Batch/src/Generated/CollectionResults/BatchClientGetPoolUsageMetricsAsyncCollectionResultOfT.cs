...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetPoolUsageMetricsAsyncCollectionResultOfT : AsyncPageable<BatchPoolUsageMetrics>
    {
        ...
        public BatchClientGetPoolUsageMetricsAsyncCollectionResultOfT(BatchClient client, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, DateTimeOffset? starttime, DateTimeOffset? endtime, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _timeout = timeout;

...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetApplicationsCollectionResult : Pageable<BinaryData>
    {
        ...
        public BatchClientGetApplicationsCollectionResult(BatchClient client, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _timeout = timeout;

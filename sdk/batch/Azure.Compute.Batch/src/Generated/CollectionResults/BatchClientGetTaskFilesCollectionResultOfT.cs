...
{
    internal partial class BatchClientGetTaskFilesCollectionResultOfT : Pageable<BatchNodeFile>
    {
        ...
        /// <summary> Initializes a new instance of BatchClientGetTaskFilesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BatchClientGetTaskFilesCollectionResultOfT(BatchClient client, string jobId, string taskId, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, string filter, bool? recursive, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _jobId = jobId;
            _taskId = taskId;
        ...
        /// <summary> Gets the pages of BatchClientGetTaskFilesCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BatchClientGetTaskFilesCollectionResultOfT as an enumerable collection. </returns>

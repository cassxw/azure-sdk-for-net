...
{
    internal partial class BatchClientGetNodeExtensionsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of BatchClientGetNodeExtensionsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public BatchClientGetNodeExtensionsAsyncCollectionResult(BatchClient client, string poolId, string nodeId, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, IEnumerable<string> @select, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _poolId = poolId;
            _nodeId = nodeId;
        ...
        /// <summary> Gets the pages of BatchClientGetNodeExtensionsAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BatchClientGetNodeExtensionsAsyncCollectionResult as an enumerable collection. </returns>

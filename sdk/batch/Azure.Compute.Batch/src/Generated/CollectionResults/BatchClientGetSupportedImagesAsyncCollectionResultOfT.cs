...
{
    internal partial class BatchClientGetSupportedImagesAsyncCollectionResultOfT : AsyncPageable<BatchSupportedImage>
    {
        ...
        public BatchClientGetSupportedImagesAsyncCollectionResultOfT(BatchClient client, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _timeout = timeout;
        ...
        /// <summary> Gets the pages of BatchClientGetSupportedImagesAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BatchClientGetSupportedImagesAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<BatchSupportedImage>> AsPages(string continuationToken, int? pageSizeHint)
        {

...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetTaskFilesAsyncCollectionResultOfT : AsyncPageable<BatchNodeFile>
    {
        ...
        /// <summary> Initializes a new instance of BatchClientGetTaskFilesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BatchClientGetTaskFilesAsyncCollectionResultOfT(BatchClient client, string jobId, string taskId, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, string filter, bool? recursive, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _jobId = jobId;
            _taskId = taskId;
        ...
        /// <summary> Gets the pages of BatchClientGetTaskFilesAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BatchClientGetTaskFilesAsyncCollectionResultOfT as an enumerable collection. </returns>

...
{
    internal partial class BatchClientGetPoolsAsyncCollectionResultOfT : AsyncPageable<BatchPool>
    {
        ...
        public BatchClientGetPoolsAsyncCollectionResultOfT(BatchClient client, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, string filter, IEnumerable<string> @select, IEnumerable<string> expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _timeout = timeout;
        ...
        /// <summary> Gets the pages of BatchClientGetPoolsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BatchClientGetPoolsAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<BatchPool>> AsPages(string continuationToken, int? pageSizeHint)
        {

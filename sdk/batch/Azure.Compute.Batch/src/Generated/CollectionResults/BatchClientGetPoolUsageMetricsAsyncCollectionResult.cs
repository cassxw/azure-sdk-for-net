...
{
    internal partial class BatchClientGetPoolUsageMetricsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BatchClientGetPoolUsageMetricsAsyncCollectionResult(BatchClient client, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, DateTimeOffset? starttime, DateTimeOffset? endtime, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _timeout = timeout;
        ...
        /// <summary> Gets the pages of BatchClientGetPoolUsageMetricsAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BatchClientGetPoolUsageMetricsAsyncCollectionResult as an enumerable collection. </returns>

...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetJobsFromSchedulesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BatchClientGetJobsFromSchedulesAsyncCollectionResult(BatchClient client, string jobScheduleId, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, string filter, IEnumerable<string> @select, IEnumerable<string> expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;

...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetJobPreparationAndReleaseTaskStatusesAsyncCollectionResultOfT : AsyncPageable<BatchJobPreparationAndReleaseTaskStatus>
    {
        ...
        public BatchClientGetJobPreparationAndReleaseTaskStatusesAsyncCollectionResultOfT(BatchClient client, string jobId, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, string filter, IEnumerable<string> @select, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _jobId = jobId;
            _timeout = timeout;

...
{
    internal partial class BatchClientGetNodesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of BatchClientGetNodesAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public BatchClientGetNodesAsyncCollectionResult(BatchClient client, string poolId, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, string filter, IEnumerable<string> @select, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _poolId = poolId;
            _timeout = timeout;
        ...
        /// <summary> Gets the pages of BatchClientGetNodesAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BatchClientGetNodesAsyncCollectionResult as an enumerable collection. </returns>

...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetJobsAsyncCollectionResultOfT : AsyncPageable<BatchJob>
    {
        ...
        public BatchClientGetJobsAsyncCollectionResultOfT(BatchClient client, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, string filter, IEnumerable<string> @select, IEnumerable<string> expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _timeout = timeout;

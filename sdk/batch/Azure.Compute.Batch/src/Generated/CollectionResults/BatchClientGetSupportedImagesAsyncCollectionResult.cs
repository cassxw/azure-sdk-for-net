...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetSupportedImagesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BatchClientGetSupportedImagesAsyncCollectionResult(BatchClient client, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _timeout = timeout;

...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetNodeExtensionsCollectionResultOfT : Pageable<BatchNodeVMExtension>
    {
        ...
        public BatchClientGetNodeExtensionsCollectionResultOfT(BatchClient client, string poolId, string nodeId, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, IEnumerable<string> @select, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _poolId = poolId;
            _nodeId = nodeId;

...
{
    internal partial class BatchClientGetPoolNodeCountsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BatchClientGetPoolNodeCountsAsyncCollectionResult(BatchClient client, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _timeout = timeout;
        ...
        /// <summary> Gets the pages of BatchClientGetPoolNodeCountsAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BatchClientGetPoolNodeCountsAsyncCollectionResult as an enumerable collection. </returns>

...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetSubTasksAsyncCollectionResultOfT : AsyncPageable<BatchSubtask>
    {
        ...
        public BatchClientGetSubTasksAsyncCollectionResultOfT(BatchClient client, string jobId, string taskId, TimeSpan? timeout, DateTimeOffset? requestDate, IEnumerable<string> @select, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _jobId = jobId;
            _taskId = taskId;

...
namespace Azure.Compute.Batch
{
    internal partial class BatchClientGetApplicationsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BatchClientGetApplicationsAsyncCollectionResult(BatchClient client, TimeSpan? timeout, DateTimeOffset? requestDate, int? maxresults, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _timeout = timeout;

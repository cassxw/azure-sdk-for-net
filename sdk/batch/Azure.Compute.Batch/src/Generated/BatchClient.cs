...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchClient
    {
        ...
        {
            return new BatchClientGetApplicationsCollectionResult(this, timeout, requestDate, maxresults, context);
        }
        ...
        {
            return new BatchClientGetApplicationsAsyncCollectionResult(this, timeout, requestDate, maxresults, context);
        }
        ...
        {
            return new BatchClientGetApplicationsCollectionResultOfT(this, timeout, requestDate, maxresults, cancellationToken.ToRequestContext());
        }
        ...
        {
            return new BatchClientGetApplicationsAsyncCollectionResultOfT(this, timeout, requestDate, maxresults, cancellationToken.ToRequestContext());
        }
